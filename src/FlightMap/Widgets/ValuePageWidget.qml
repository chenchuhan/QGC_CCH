            ...
            QGCFlickable {
                ...
                Column {
                    ...
                    */
                    ...
                    Repeater {
                        model: _activeVehicle.factGroupNames   //获取键值对中的键
                        ...
                        Loader {
                            ...
                            property var    factGroup:     _activeVehicle.getFactGroup(modelData) ////根据键获取 键值对中的值
...
//                        }
                        ...
                        //start_cch_20210329
                        function removeFromList(list, value) {
                            list.removeOne(value);//删除一个指定的元素，删除成功返回true，删除失败返回fasle
                            return list
                        }
