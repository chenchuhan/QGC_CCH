...
UrlFactory::UrlFactory() : _timeout(5 * 1000) {
    ...
    _providersTable["高德 卫星地图1"] = new GaodeSatMapProvider(this);
    _providersTable["高德 卫星地图2"] = new GaodeNewSatMapProvider(this);

    _providersTable["天地 卫星地图"] = new TiandiSatMapProvider(this);
    //end_cch
}
