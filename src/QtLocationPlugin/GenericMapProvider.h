...
//start_cch_xx_20210223
class GaodeNewSatMapProvider : public MapProvider {
    Q_OBJECT
  public:
    GaodeNewSatMapProvider(QObject* parent = nullptr)
        : MapProvider(QStringLiteral("webapi.amap.com"), QStringLiteral("jpg"),
                      AVERAGE_TILE_SIZE, QGeoMapType::SatelliteMapDay, parent) {}
...
//start_cch_xx_20210201
class TiandiSatMapProvider : public MapProvider {
    Q_OBJECT
  public:
    TiandiSatMapProvider(QObject* parent = nullptr)
        : MapProvider(QStringLiteral("webapi.amap.com"), QStringLiteral("jpg"),
                      AVERAGE_TILE_SIZE, QGeoMapType::SatelliteMapDay, parent) {}
